...
class __TwigTemplate_9804ab94ff13a538c449bc82ad0229e5 extends Template
{
    ...
    public function block_head(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "hasexception", [], "any", false, false, false, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            ";
            // line 7
            yield (string) Twig\Extension\CoreExtension::include($this->env, $context, "@WebProfiler/Collector/exception.css.twig");
            yield "
        </style>
    ";
        }
...
";
    ...
    public function block_menu(array $context, array $blocks = []): iterable
    {
        ...
        // line 15
        yield (string) Twig\Extension\CoreExtension::source($this->env, "@WebProfiler/Icon/exception.svg");
        yield "</span>
...
";
    ...
    {
        return array (  188 => 42,  185 => 41,  179 => 37,  177 => 36,  167 => 28,  165 => 26,  152 => 25,  140 => 22,  134 => 18,  132 => 17,  127 => 15,  122 => 14,  109 => 13,  95 => 10,  89 => 7,  85 => 6,  82 => 5,  79 => 4,  66 => 3,  43 => 1,);
    }
...
{% block menu %}
    <span class=\"label {{ collector.hasexception ? \x27label-status-error\x27 : \x27disabled\x27 }}\">
        <span class=\"icon\" aria-hidden=\"true\">{{ source(\x27@WebProfiler/Icon/exception.svg\x27) }}</span>
        <strong>Exception</strong>
        {% if collector.hasexception %}
            <span class=\"count\">
                <span>1</span>
