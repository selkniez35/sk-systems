...
class __TwigTemplate_e7c5db2b0caa7c1a49501e59c7820bb3 extends Template
{
...
";
    ...
    <div class=\"card break-long-words\">
        ";
            // line 27
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["router"]) || array_key_exists("router", $context) ? $context["router"] : (function () { throw new RuntimeError('Variable "router" does not exist.', 27, $this->source); })()), "targetUrl", [], "any", false, false, false, 27), "html", null, true);
            yield "
        ";
            // line 28
...
<div class=\"card\">
    <strong>Path to match:</strong> <code>";
        // line 35
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 35, $this->source); })()), "pathinfo", [], "any", false, false, false, 35), "html", null, true);
        yield "</code>
</div>
...
<table id=\"router-logs\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
            ...
            // line 50
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 50), "html", null, true);
            yield "</td>
            <td class=\"break-long-words\">";
            // line 51
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "name", [], "any", false, false, false, 51), "html", null, true);
            yield "</td>
            <td class=\"break-long-words\">";
            // line 52
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "path", [], "any", false, false, false, 52), "html", null, true);
            yield "</td>
            ...
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "level", [], "any", false, false, false, 54) == 1)) {
                ...
                yield "                    Path almost matches, but
                    <span class=\"newline\">";
                // line 56
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "log", [], "any", false, false, false, 56), "html", null, true);
                yield "</span>
                ";
...
$context["trace"], "level", [], "any", false, false, false, 57) == 2)) {
                // line 58
                yield "                    ";
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "log", [], "any", false, false, false, 58), "html", null, true);
                yield "
                ";
            } else {
                // line 60
...
";
    ...
    {
        return array (  204 => 65,  187 => 62,  183 => 60,  177 => 58,  175 => 57,  171 => 56,  168 => 55,  166 => 54,  161 => 52,  157 => 51,  153 => 50,  148 => 49,  131 => 48,  115 => 35,  109 => 31,  105 => 29,  99 => 28,  95 => 27,  89 => 23,  87 => 22,  84 => 21,  77 => 18,  71 => 14,  69 => 13,  65 => 11,  63 => 10,  55 => 5,  49 => 1,);
    }
...
", "@WebProfiler/Router/panel.html.twig", "/var/www/sk-systems/vendor/symfony/web-profiler-bundle/Resources/views/Router/panel.html.twig");
    }
}
