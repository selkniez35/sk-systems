...
class __TwigTemplate_356271339f3c48ab51190792ff480264 extends Template
{
    ...
    ";
        ...
        <div class=\"sf-toolbar-info-piece\">
            ...
            // line 15
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 15, $this->source); })()), "html", null, true);
            yield "\"></span>
        </div>
        <div class=\"sf-toolbar-info-piece\">
            <b>
            ...
            // line 19
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 19, $this->source); })()), "html", null, true);
    ...
    ";
        // line 24
        yield (string) Twig\Extension\CoreExtension::include($this->env, $context, "@WebProfiler/Profiler/toolbar_item.html.twig", ["link" => (isset($context["profiler_url"]) || array_key_exists("profiler_url", $context) ? $context["profiler_url"] : (function () { throw new RuntimeError('Variable "profiler_url" does not exist.', 24, $this->source); })())]);
        yield "
";
    ...
    {
        return array (  116 => 24,  113 => 23,  105 => 19,  98 => 15,  92 => 11,  90 => 10,  87 => 9,  76 => 3,  73 => 2,  50 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Profiler/cancel.html.twig", "/var/www/sk-systems/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/cancel.html.twig");
    }
}
