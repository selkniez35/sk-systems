...
class __TwigTemplate_a9ab391de6fc9a58c13c409856e67efd extends Template
{
...
";
    ...
    public function block_panel(array $context, array $blocks = []): iterable
    {
        ...
        // line 63
        yield (string) ((("request" == (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 63, $this->source); })()))) ? ("active") : (""));
        yield "\" role=\"tab\" ";
        yield (string) ((("request" == (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 63, $this->source); })()))) ? ("aria-selected=\"true\"") : ("tabindex=\"-1\""));
        yield " >
                <a href=\"";
        // line 64
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler_search_results", ["token" => "empty", "limit" => 10]), "html", null, true);
        yield "\">
                    HTTP Requests
                </a>
            </button>
            <button class=\"tab-control ";
        // line 68
        yield (string) ((("command" == (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 68, $this->source); })()))) ? ("active") : (""));
        yield "\" role=\"tab\" ";
        yield (string) ((("command" == (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 68, $this->source); })()))) ? ("aria-selected=\"true\"") : ("tabindex=\"-1\""));
        yield ">
                <a href=\"";
        // line 69
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler_search_results", ["token" => "empty", "limit" => 10, "type" => "command"]), "html", null, true);
        yield "\">
                    Console Commands
                </a>
            </button>
        ...
        if ((($tmp = (isset($context["tokens"]) || array_key_exists("tokens", $context) ? $context["tokens"] : (function () { throw new RuntimeError('Variable "tokens" does not exist.', 78, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
                ...
                if (("command" == (isset($context["profile_type"]) || array_key_exists("profile_type", $context) ? $context["profile_type"] : (function () { throw new RuntimeError('Variable "profile_type" does not exist.', 116, $this->source); })()))) {
                    ...
                    // line 118
                    yield "                        ";
                    $context["has_errors"] = ((($tmp = ((CoreExtension::getAttribute($this->env, $this->source, $context["result"], "has_errors", [], "any", true, true, false, 118)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "has_errors", [], "any", false, false, false, 118), false)) : (false))) && $tmp instanceof Markup ? (string) $tmp : $tmp) && (CoreExtension::getAttribute($this->env, $this->source, $context["result"], "status_code", [], "any", false, false, false, 118) == 0));
                    // line 119
                    yield "                    ";
                } else {
                    // line 120
                    ...
                    // line 121
                    yield "                        ";
                    $context["has_errors"] = ((($tmp = ((CoreExtension::getAttribute($this->env, $this->source, $context["result"], "has_errors", [], "any", true, true, false, 121)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "has_errors", [], "any", false, false, false, 121), false)) : (false))) && $tmp instanceof Markup ? (string) $tmp : $tmp) && (CoreExtension::getAttribute($this->env, $this->source, $context["result"], "status_code", [], "any", false, false, false, 121) < 400));
                    // line 122
                    yield "                    ";
                }
                // line 123
                    ...
                    <tr>
                        <td class=\"text-center\">
                            <span class=\"status-with-indicator\">
                                <span class=\"label ";
                // line 127
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["css_class"]) || array_key_exists("css_class", $context) ? $context["css_class"] : (function () { throw new RuntimeError('Variable "css_class" does not exist.', 127, $this->source); })()), "html", null, true);
                yield "\">";
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["result"], "status_code", [], "any", true, true, false, 127)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "status_code", [], "any", false, false, false, 127), "n/a")) : ("n/a")), "html", null, true);
                yield "</span>";
                // line 128
                ...
                yield "</span>
                        ...
                        <td>
                            <span class=\"nowrap\">";
                // line 134
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "ip", [], "any", false, false, false, 134), "html", null, true);
                yield " ";
                yield (string) $this->getTemplateForMacro("macro_profile_search_filter", $context, 134, $this->getSourceContext())->macro_profile_search_filter(...[(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 134, $this->source); })()), $context["result"], "ip"]);
                yield "</span>
                        </td>
                        <td>
                            <span class=\"nowrap\">";
                // line 137
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "method", [], "any", false, false, false, 137), "html", null, true);
                yield " ";
                yield (string) $this->getTemplateForMacro("macro_profile_search_filter", $context, 137, $this->getSourceContext())->macro_profile_search_filter(...[(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 137, $this->source); })()), $context["result"], "method"]);
                yield "</span>
                        </td>
                        <td class=\"break-long-words\">
                            ";
                // line 140
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "url", [], "any", false, false, false, 140), "html", null, true);
                yield "
                            ";
                // line 141
                yield (string) $this->getTemplateForMacro("macro_profile_search_filter", $context, 141, $this->getSourceContext())->macro_profile_search_filter(...[(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 141, $this->source); })()), $context["result"], "url"]);
                yield "
                        </td>
                        <td class=\"text-small\">
                            <time data-convert-to-user-timezone data-render-as-date datetime=\"";
                // line 144
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, false, 144), "c"), "html", null, true);
                yield "\">
                                ";
                // line 145
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, false, 145), "d-M-Y"), "html", null, true);
                yield "
                            </time>
                            <time class=\"newline\" data-convert-to-user-timezone data-render-as-time datetime=\"";
                // line 147
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, false, 147), "c"), "html", null, true);
                yield "\">
                                ";
                // line 148
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, false, 148), "H:i:s"), "html", null, true);
                yield "
                            </time>
                        </td>
                        <td class=\"nowrap\"><a href=\"";
                // line 151
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", ["token" => CoreExtension::getAttribute($this->env, $this->source, $context["result"], "token", [], "any", false, false, false, 151)]), "html", null, true);
                yield "\">";
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "token", [], "any", false, false, false, 151), "html", null, true);
                yield "</a></td>
                    </tr>
                ";
            }
...
";
    ...
    public function macro_profile_search_filter($request = null, $result = null, $property = null, ...$varargs): string|Markup
    {
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 4, $this->source); })()), "hasSession", [], "any", false, false, false, 4)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                yield (string) Twig\Extension\CoreExtension::source($this->env, "@WebProfiler/Icon/search.svg");
                yield "</span></a>";
            }
    ...
    {
        return array (  479 => 5,  477 => 4,  457 => 3,  445 => 161,  439 => 157,  434 => 154,  422 => 151,  416 => 148,  412 => 147,  407 => 145,  403 => 144,  397 => 141,  393 => 140,  385 => 137,  377 => 134,  372 => 131,  367 => 129,  365 => 128,  360 => 127,  354 => 123,  351 => 122,  348 => 121,  345 => 120,  342 => 119,  339 => 118,  336 => 117,  333 => 116,  329 => 115,  321 => 109,  317 => 107,  313 => 105,  311 => 104,  307 => 102,  303 => 100,  299 => 98,  297 => 97,  293 => 95,  289 => 93,  285 => 91,  283 => 90,  279 => 88,  275 => 86,  271 => 84,  269 => 83,  263 => 79,  261 => 78,  256 => 76,  246 => 69,  240 => 68,  233 => 64,  227 => 63,  223 => 61,  210 => 60,  197 => 57,  192 => 56,  179 => 55,  157 => 54,  143 => 49,  130 => 48,  81 => 10,  68 => 9,  45 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Profiler/results.html.twig", "/var/www/sk-systems/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/results.html.twig");
    }
}
