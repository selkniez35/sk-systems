...
class __TwigTemplate_9655cdafa0e65f7f8e0de6f8c2803935 extends Template
{
...
";
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 39, $this->source); })()), "requestCount", [], "any", false, false, false, 39)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            ";
                ...
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 43, $this->source); })()), "requestCount", [], "any", false, false, false, 43), "html", null, true);
                yield "</span>
        ";
                yield from [];
        ...
        ";
            ...
            $context["text"] = ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
                ...
                <span>";
                // line 49
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 49, $this->source); })()), "requestCount", [], "any", false, false, false, 49), "html", null, true);
                yield "</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                ...
                yield "\">";
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 53, $this->source); })()), "errorCount", [], "any", false, false, false, 53), "html", null, true);
                yield "</span>
            </div>
        ";
                yield from [];
    ...
    ";
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 65, $this->source); })()), "requestCount", [], "any", false, false, false, 65)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            ";
            // line 67
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 67, $this->source); })()), "requestCount", [], "any", false, false, false, 67), "html", null, true);
            yield "
        </span>
    ";
        }
...
";
    ...
    ";
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 82
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 82, $this->source); })()), "requestCount", [], "any", false, false, false, 82), "html", null, true);
            yield "</span>
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 86
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 86, $this->source); })()), "errorCount", [], "any", false, false, false, 86), "html", null, true);
            yield "</span>
        ...
        <div class=\"sf-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                ...
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 94)), "html", null, true);
                yield "</span></h3>
                ...
                if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 96)) == 0)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                        ...
                        // line 119
                        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "method", [], "any", false, false, false, 119), "html", null, true);
                        yield "</span>
                                        </th>
                                        <th class=\"full-width\">
                                            ";
                        // line 122
                        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "url", [], "any", false, false, false, 122), "html", null, true);
                        yield "
                                        </th>
                                        ";
                        // line 124
                        ...
                        if ((CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", true, true, false, 129) && (($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 129)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
                            ...
                            // line 131
                            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 131), "html", null, true);
                        ...
                        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["responseStatus"]) || array_key_exists("responseStatus", $context) ? $context["responseStatus"] : (function () { throw new RuntimeError('Variable "responseStatus" does not exist.', 153, $this->source); })()), "html", null, true);
                        yield "\">
                                                ";
                        // line 154
                        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "http_code", [], "any", false, false, false, 154), "html", null, true);
                        yield "
                                            </span>
                        ...
                        if (((($tmp = (isset($context["profiler_token"]) || array_key_exists("profiler_token", $context) ? $context["profiler_token"] : (function () { throw new RuntimeError('Variable "profiler_token" does not exist.', 159, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp) && (($tmp = (isset($context["profiler_link"]) || array_key_exists("profiler_link", $context) ? $context["profiler_link"] : (function () { throw new RuntimeError('Variable "profiler_link" does not exist.', 159, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
                            ...
                            yield "                                            <td>
                                                <span><a href=\"";
                            // line 161
                            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["profiler_link"]) || array_key_exists("profiler_link", $context) ? $context["profiler_link"] : (function () { throw new RuntimeError('Variable "profiler_link" does not exist.', 161, $this->source); })()), "html", null, true);
                            yield "\" target=\"_blank\">";
                            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["profiler_token"]) || array_key_exists("profiler_token", $context) ? $context["profiler_token"] : (function () { throw new RuntimeError('Variable "profiler_token" does not exist.', 161, $this->source); })()), "html", null, true);
                            yield "</a></span>
                                            </td>
                                        ";
                        }
...
";
    ...
    {
        return array (  504 => 173,  501 => 172,  492 => 169,  489 => 168,  479 => 164,  471 => 161,  468 => 160,  466 => 159,  461 => 157,  455 => 154,  450 => 153,  447 => 152,  444 => 151,  441 => 150,  438 => 149,  435 => 148,  432 => 147,  430 => 146,  424 => 145,  420 => 143,  414 => 140,  410 => 138,  408 => 137,  403 => 134,  397 => 131,  394 => 130,  391 => 129,  385 => 125,  383 => 124,  378 => 122,  372 => 119,  366 => 115,  363 => 114,  356 => 113,  353 => 112,  350 => 111,  347 => 110,  344 => 109,  341 => 108,  338 => 107,  333 => 106,  330 => 105,  327 => 104,  324 => 103,  320 => 102,  317 => 101,  311 => 98,  308 => 97,  306 => 96,  299 => 94,  294 => 93,  290 => 92,  281 => 86,  274 => 82,  270 => 80,  264 => 76,  262 => 75,  259 => 74,  246 => 73,  234 => 70,  228 => 67,  225 => 66,  223 => 65,  218 => 63,  213 => 62,  200 => 61,  186 => 57,  183 => 56,  174 => 53,  167 => 49,  163 => 47,  161 => 46,  158 => 45,  151 => 43,  149 => 42,  144 => 41,  141 => 40,  138 => 39,  125 => 38,  80 => 4,  67 => 3,  44 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "/var/www/sk-systems/vendor/symfony/web-profiler-bundle/Resources/views/Collector/http_client.html.twig");
    }
}
