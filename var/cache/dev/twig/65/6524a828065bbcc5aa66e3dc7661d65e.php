...
class __TwigTemplate_4ec36a4e6ed34a98d620dd7b26989662 extends Template
{
...
";
        // line 7
        yield "<script";
        if ((array_key_exists("csp_script_nonce", $context) && (($tmp = (isset($context["csp_script_nonce"]) || array_key_exists("csp_script_nonce", $context) ? $context["csp_script_nonce"] : (function () { throw new RuntimeError('Variable "csp_script_nonce" does not exist.', 7, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
            yield " nonce=\"";
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["csp_script_nonce"]) || array_key_exists("csp_script_nonce", $context) ? $context["csp_script_nonce"] : (function () { throw new RuntimeError('Variable "csp_script_nonce" does not exist.', 7, $this->source); })()), "html", null, true);
            yield "\"";
        }
        yield ">
...
", "@WebProfiler/Profiler/base_js.html.twig", "/var/www/sk-systems/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/base_js.html.twig");
    }
}
